using BattPhase, LinearAlgebra, MKL, Pardiso, BenchmarkTools, SparseArrays, Plots#, ProfileView, Infiltrator
#using BattPhase, LinearAlgebra, BenchmarkTools, SparseArrays, Plots#, ProfileView, Infiltrator
    ...
    @inline function pdrk3asolve(Y,Φ,Φₜ,Φₘ,F,dt,N,M,δ,ki,ymid,j,Ntot,tt,tf,TT,V,V1,V2,ff,dᵦ,ν,vv,h,Φₐ)
        i = 1
    ...
    # @time Ydata_rk3a, V_rk3a, V1_rk3a, V2_rk3a, TT_rk3a, Φₐ_rk3a = pdrk3asolve(Y₀,Φ₀,Φₜ₀,Φₘ₀,F₀,dt₀,N,M,δ,ki₀,ymid₀,j₀,Ntot,tt,tf,TT,V,V1,V2,ff₀,dᵦ₀,ν,vv₀,h,Φₐ₀)
